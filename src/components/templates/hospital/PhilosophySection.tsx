...
export default function PhilosophySection() {
  ...
  useEffect(() => {
    fetch(`${API_BASE}/api/hospitals/1/philosophies`)
      .then((res) => res.json())
      .then((data) => setPhilosophies(Array.isArray(data) ? data : []))
      .catch(() => {})
      ...
      <section className="section-padding bg-white">
        <div className="section-narrow">
          ...
          <div className="flex justify-center">
            <div className="w-8 h-8 border-2 border-hospital-gold border-t-transparent rounded-full animate-spin" />
          </div>
        </div>
      </section>
    );
