...
from app.routers import auth, hospitals, doctors, treatments, promotions, spaces, uploads, shopping, corporate, landing, sites, templates, pages, site_configs, dashboard
